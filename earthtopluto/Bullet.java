...
public class Bullet {
    ...
    public final static long timeBetweenNewBullets = Panel2.secInNanosec / 10;
    ...
    // Images of rocket machine gun bullet. Image is loaded and set in Game class in LoadContent() method.
    ...
    private void setDirectionAndSpeed(Point mousePosition)
    {
     ...
     //   double directionVx = mousePosition.x - this.xCoordinate;
      ...
      //  directionVy = directionVy / lengthOfVector; // Unit vector
        ...
        this.movingYspeed = 0;//bulletSpeed * directionVy;
    }
    ...
    {
        if(xCoordinate > 0 && xCoordinate < Panel2.frameWidth &&
           yCoordinate > 0 && yCoordinate < Panel2.frameHeight)
            return false;
        else
            return true;
    }
